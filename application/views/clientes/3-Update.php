  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">GoldenTradeValue - Clientes Actualizar</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary   text-capitalize"   id="btnUpdateUser">actualizar cliente</button>
      </div>        
      </div>
    </div>
  </div>
